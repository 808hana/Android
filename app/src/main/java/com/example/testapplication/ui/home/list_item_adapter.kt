...
class MyListAdapter(private val context: Context, private val items: List<ImageHit>) : ArrayAdapter<ImageHit>(context, 0, items) {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        textViewBrightness.text = "URL:  ${item.webformatURL}"
        return view
    }
}